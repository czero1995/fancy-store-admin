  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <el-table-column v-if="onShowTableItem('页面标题')" width="120" align="center" label="页面标题">
          <template slot-scope="scope">
            <span>点击</span>
          </template>
        </el-table-column>
        ...
        <el-table-column v-if="onShowTableItem('分享链接')" width="220" label="分享链接" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column v-if="onShowTableItem('评论数')" width="80" label="评论数">
          <template slot-scope="scope"/>
        </el-table-column>
        <el-table-column v-if="onShowTableItem('允许评论')" width="100" label="允许评论" align="center"/>
        <el-table-column v-if="onShowTableItem('阅读用户数')" width="80" label="阅读用户数">
          <template slot-scope="scope"/>
        </el-table-column>
...
import { tabPost } from "@/utils/commonUseTableData";
